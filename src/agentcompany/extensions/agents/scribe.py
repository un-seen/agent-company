...
from agentcompany.framework.scribe import ScribePattern
from agentcompany.mcp.base import ModelContextProtocolImpl
from agentcompany.llms.openai import OpenAIServerLLM
from pathlib import Path

def ScribeAgent(name: str, 
                    session_id: str,
                    interface_id: str, 
                    description: str, 
                    custom_yaml_path: str = None,
                    mcp_servers: List[ModelContextProtocolImpl] = []) -> ScribePattern:
    """
    Create a Scribe code agent.
    """
    default_yaml_path = importlib.resources.files("agentcompany.extensions.prompts.scribe").joinpath("default.yaml")
